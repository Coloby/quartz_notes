...
- I use spaces & dividers to determine importancy, e.g.
	...
	![[Pasted image 20241117153344.png]] 
- why do you have so few folders?
	- I organize notes through connections, not folders. That's why [[vault map]] is so important for finding notes you might need
- why don't you use headings?
	- I hate them 
		- takes too much space
		- strange behaviors when folding stuff
		- take too much brain power to make them (##### = heading 5)
...
- Patterns/Conventions
	...
	- archived - stuff I no longer count as relevant 
		- there just because I don’t want to delete them or archivial reasons
	- source mentioning
		- general sources
			- src
			- -
