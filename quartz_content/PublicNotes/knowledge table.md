...
- Naming conventions
	...
	- f (flow) system/blueprint to create something, e.g. [[fCode]]
	...
	- l (learn) - mentors/resources/archived best content, e.g. [[lCode]]
		- mostly used as a start to better explore the category itself
